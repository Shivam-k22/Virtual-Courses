        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button
              ...
              className="border-2 border-blue-400 hover:border-white text-white font-bold text-sm px-8 py-4 rounded-2xl transition-all duration-200 hover:bg-blue-800"
            >
              Get In Touch
            </button>
          </div>
      ...
      <section className="w-full bg-white py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {instructors.map(({ name, role, courses, students, rating, img, bg }) => (
              <div key={name} className="group flex flex-col items-center gap-4 p-6 rounded-2xl border-2 border-slate-100 hover:border-blue-300 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-white">
                {/* Avatar */}
                <div className="relative">
                  <img
                    src={img}
                  ...
                  />
                  <div className={`absolute -bottom-2 -right-2 w-7 h-7 ${bg} rounded-full flex items-center justify-center shadow-md`}>
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-blue-600 font-semibold mt-1">{role}</p>
                </div>
                {/* Stats */}
                <div className="w-full flex justify-between items-center px-2 pt-2 border-t border-slate-100">
                  <div className="text-center">
                    <div className="text-xs font-black text-slate-800">{courses}</div>
                    <div className="text-[10px] text-slate-400 mt-0.5">Courses</div>
                  </div>
                  <div className="w-px h-6 bg-slate-100" />
                  <div className="text-center">
                    <div className="text-xs font-black text-slate-800">{students}</div>
                    <div className="text-[10px] text-slate-400 mt-0.5">Students</div>
                  </div>
                  <div className="w-px h-6 bg-slate-100" />
                  <div className="text-center flex flex-col items-center">
                    <div className="text-xs font-black text-amber-500 flex items-center gap-0.5">
                      ★ {rating}
                    </div>
                ...
                <div className="flex items-center gap-3">
                  <FaLinkedin className="w-4 h-4 text-slate-300 hover:text-blue-600 cursor-pointer transition-colors" />
                  <FaTwitter className="w-4 h-4 text-slate-300 hover:text-sky-500 cursor-pointer transition-colors" />
                  <FaGithub className="w-4 h-4 text-slate-300 hover:text-slate-700 cursor-pointer transition-colors" />
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button
              ...
              className="border-2 border-white text-white hover:bg-blue-500 font-bold text-sm px-10 py-4 rounded-2xl transition-all duration-200"
            >
              Sign Up Free
            </button>
          </div>
